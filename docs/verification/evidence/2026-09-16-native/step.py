...
root = Path('/tmp/ya-native-20260916/matrix-nonkey')
...
cli = '/Users/phaethon/workspace/personal/worktrees/computer-use-takeover-20260916/dist/release/ya-skills/yk'
started = time.time()
