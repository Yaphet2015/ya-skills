import AppKit
let root = "/tmp/ya-native-20260916/matrix"
...
let handler = Handler()
let panel = NSPanel(contentRect: NSRect(x: 80, y: 100, width: 520, height: 300), styleMask: [.titled, .nonactivatingPanel], backing: .buffered, defer: false)
