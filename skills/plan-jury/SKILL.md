...
| grok | xai/grok-4.7 | xhigh | `grok.md` |
...
bangboo --model xai/grok-4.7 --thinking xhigh --tools read,bash,edit,write,grep,find,ls --no-skills -a -p "${prompt[@]}" "Output file: grok.md" > grok.log 2>&1 &
